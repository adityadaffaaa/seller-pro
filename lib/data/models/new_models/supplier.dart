...
class SupplierDataResponseItem {
  ...
  factory SupplierDataResponseItem.fromJson(Map<String, dynamic> json) =>
      SupplierDataResponseItem(
        ...
        commission: json["commission"].runtimeType == int
...
class FeeServiceAddProductResponse {
  FeeServiceAddProductResponse({
    this.data,
  });

  final FeeServiceAddProduct data;

  factory FeeServiceAddProductResponse.fromJson(Map<String, dynamic> json) =>
      FeeServiceAddProductResponse(
        data: json["data"] != null
            ? FeeServiceAddProduct.fromJson(json["data"])
            : null,
      );
}

class FeeServiceAddProduct {
  FeeServiceAddProduct({
    this.id,
    this.minPrice,
    this.maxPrice,
    this.cost,
  ...
  factory FeeServiceAddProduct.fromJson(Map<String, dynamic> json) =>
      FeeServiceAddProduct(
        id: json["id"],
