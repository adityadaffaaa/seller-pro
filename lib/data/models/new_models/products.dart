...
class Products extends Equatable {
  ...
  String videoLink;
  Supplier supplier;
  Reseller resellerWebStore;
  List<Reseller> reseller;
  List<ProductGroceries> productGroceries;
  List<ProductAssets> productAssets;
  ...
  factory Products.fromJson(Map<String, dynamic> json) => Products(
        ...
        commission: json["commission"].runtimeType == double
            ? json["commission"].toInt()
            : json["commission"] ?? 0,
        commissionPrice: json["commission_price"].runtimeType == double
            ? json["commission_price"].toInt()
            : json["commission_price"] ?? 0,
        ...
        //     ? []
        //     : json["reseller"].length == 0
        //         ? []
        //         : List<Reseller>.from(json["reseller"]
        //             .map((x) => Reseller.fromJson(x))),
        resellerWebStore: json["reseller_webstore"] != null
            ? Reseller.fromJson(json["reseller_webstore"])
            : null,
        bumdes: json["unit"],
        ...
        productAssets: json["product_assets"] == null
            ...
            : json["product_assets"].length == 0
                ? []
                : List<ProductAssets>.from(json["product_assets"]
                    .map((x) => ProductAssets.fromJson(x))),
        ...
        isBeliLangsung: json["is_beli_langsung"],
        isLangganan: json["is_langganan"],
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "commision_price": commissionPrice,
        "product_sold": sold,
        "product_stock": stock,
        ...
        "supplier": supplier,
        "reseller_webstore": resellerWebStore,
        "bumdes": bumdes,
        "cover": coverPhoto,
        ...
        "is_beli_langsung": isBeliLangsung,
...
class ProductAssets {
  ProductAssets(
      {this.id, this.productId, this.submissionId, this.image, this.videoLink});
  ...
  factory ProductAssets.fromJson(Map<String, dynamic> json) => ProductAssets(
      id: json["id"] ?? 0,
      productId: json["product_id"] ?? 0,
      submissionId: json["submission_id"] ?? 0,
      image: json["image"] ?? "https://venus.bisnisomall.com/images/blank.png",
