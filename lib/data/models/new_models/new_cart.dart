...
class ProductCart {
  ...
  final List<ProductAssets> assets;
  ...
  factory ProductCart.fromJson(Map<String, dynamic> json) => ProductCart(
        ...
        assets: List<ProductAssets>.from(
            json["assets"].map((x) => ProductAssets.fromJson(x))),
      );
}
...
class NewCart {
  ...
  @override
  String toString() {
    return 'NewCart{supplierId: $supplierId, resellerId: $resellerId, nameSeller: $nameSeller, product: $product}';
  }
}
