...
class User {
  User({
    ...
    this.reseller,
    this.supplier,
    this.isMemberComplete,
    this.isOwnerComplete,
    this.idCommunity,
    this.idSeller,
  });
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
        ...
        isMemberComplete: json["is_member_complete"],
        isOwnerComplete: json["is_owner_complete"],
        idCommunity: json["id_komunitas"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "reseller": reseller,
        "supplier": supplier,
        "is_member_complete": isMemberComplete,
        "is_owner_complete": isOwnerComplete,
        "id_komunitas": idCommunity,
        "id_seller": idSeller,
      };
}
