...
class CategoryRepository {
  ...
  Future<CategorySubResponse> fetchCategorySub({int subcategoryId}) async {
    var requestUrl = '/category/show/$subcategoryId';
    final response = await _provider.get(
      requestUrl,
      headers: {
        HttpHeaders.contentTypeHeader: 'text/plain',
    ...
    return CategorySubResponse.fromJson(response);
  }
