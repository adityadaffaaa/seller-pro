...
class ProductsRepository {
  ...
  Future<SearchResponse> search({@required String keyword}) async {
    ...
    final response = await _provider.get(
        '/home/search?subdistrict=$subdistrictId&keyword=$keyword',
        headers: {
  ...
  Future<ProductsGeneralResponse> filterProduct(
      ...
      String cityId}) async {
    final response = await _provider.get(
        '/home/search?sortby_lowest_price=${sortByLowestPrice ?? ''}&sortby_highest_price=${sortByHighestPrice ?? ''}&sortby_review=${sortByReview ?? ''}&latest=${sortByLatest ?? ''}&lowest_price=${lowestPrice ?? ''}&highest_price=${highestPrice ?? ''}&province=${provinceId ?? ''}&city=${cityId ?? ''}',
        headers: {
          HttpHeaders.contentTypeHeader: 'text/plain',
          'ADS-Key': _adsKey
        });
  ...
  Future<ProductsGeneralResponse> fetchReadyToCook() async {
    int getSubdistrictId = await _recipentRepo.getMainAddressSubdistrictId();
    int getSubdistrictIdStorage =
        _recipentRepo.getSelectedSubdistrictIdStorage();
    final int subdistrictId =
    ...
    debugPrint("KECAMATAN ID NE RTC $getSubdistrictId");

    final response = await _provider
        .get('/product/subdistrict/category/$subdistrictId/2', headers: {
      HttpHeaders.contentTypeHeader: 'text/plain',
      'ADS-Key': _adsKey
    });
    return ProductsGeneralResponse.fromJson(response);
  ...
  Future<ProductsGeneralResponse> fetchRestoPanen() async {
    int getSubdistrictId = await _recipentRepo.getMainAddressSubdistrictId();
    int getSubdistrictIdStorage =
        _recipentRepo.getSelectedSubdistrictIdStorage();
    final int subdistrictId =
  ...
  Future<ProductsGeneralResponse> fetchCatering() async {
    int getSubdistrictId = await _recipentRepo.getMainAddressSubdistrictId();
    int getSubdistrictIdStorage =
        _recipentRepo.getSelectedSubdistrictIdStorage();
    final int subdistrictId =
    ...
    final response = await _provider
        .get('/product/subdistrict/category/$subdistrictId/10', headers: {
      HttpHeaders.contentTypeHeader: 'text/plain',
      'ADS-Key': _adsKey
    });
    return ProductsGeneralResponse.fromJson(response);
  ...
  Future<ProductsGeneralResponse> fetchProductsByCategory(
    ...
    debugPrint("KECAMATAN ID NE RTC $subdistrictId");
  ...
  Future<ProductsGeneralResponse> fetchProductsBySubcategory(
    ...
    final response = await _provider.get(
        "/product/subdistrict/subcategory/$subdistrictId/$subCategoryId",
        headers: {
          HttpHeaders.contentTypeHeader: 'text/plain',
          'ADS-Key': _adsKey
        });
