...
class WppChooseSubdistrictCoverageWebScreen extends StatefulWidget {
  ...
  @override
  State<WppChooseSubdistrictCoverageWebScreen> createState() =>
      _WppChooseSubdistrictCoverageWebScreenState();
}

class _WppChooseSubdistrictCoverageWebScreenState
    extends State<WppChooseSubdistrictCoverageWebScreen> {
                              ...
                              return ListTile(
                                onTap: () {
                                  ...
                                  _recipentRepo.setRecipentUserNoAuthDashboard(
                                      ...
                                      city: items[i].city);
                                  _recipentRepo
                                      .setRecipentUserNoAuthDetailProduct(
                                          subdistrictId: items[i].subdistrictId,
                                          subdistrict: items[i].subdistrictName,
                                          city: items[i].city);
                                  context.beamToNamed(
