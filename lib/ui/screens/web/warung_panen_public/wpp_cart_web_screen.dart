...
import 'widgets/cart/wpp_cart_body.dart';
import 'widgets/cart/wpp_cart_footer.dart';
import 'widgets/cart/wpp_cart_header.dart';
        ...
        if (stateStore[c].item[i].checked) {
          ...
          var newCart = CartProduct(
            ...
            initialPrice: newProduct.product.disc > 0
                ? newProduct.product.discPrice
                : newProduct.product.sellingPrice,
            productPhoto: newProduct.product.productAssets[0].image,
