...
class WppPaymentBayarLangsungScreen extends StatefulWidget {
  const WppPaymentBayarLangsungScreen({
    Key key,
    this.productSelected,
    this.variants, this.alamatPelanggan,
  }) : super(key: key);
  ...
  @override
  _WppPaymentBayarLangsungScreenState createState() =>
      _WppPaymentBayarLangsungScreenState();
}

class _WppPaymentBayarLangsungScreenState
    extends State<WppPaymentBayarLangsungScreen> {
  ...
  void handleBayar({@required int paymentMethodId}) {
    ...
    _addOrderNoCartCubit.orderNoAuth(
      ...
      name: widget.alamatPelanggan.nama, 
      phoneNumber: widget.alamatPelanggan.telepon, 
      email: widget.alamatPelanggan.email, 
      address: widget.alamatPelanggan.alamat, 
      subdistrictId: widget.alamatPelanggan.idKecamatan);
  }
                ...
                listener: (context, state) async {
                  if (state is AddOrderNoCartSuccess) {
                    AppExt.popScreen(context);
                      context.beamToNamed(
                          '/wpp/paymentLangsungDetail?dt=${AppExt.encryptMyData(jsonEncode(state.data))}');
                  }
