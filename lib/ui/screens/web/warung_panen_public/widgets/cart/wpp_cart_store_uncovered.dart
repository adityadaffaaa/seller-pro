...
import 'package:marketplace/ui/screens/mobile/product_detail/widget/rounded_container.dart';
import 'package:marketplace/utils/extensions.dart' as AppExt;
import 'package:marketplace/utils/typography.dart' as AppTypo;

import 'wpp_cart_store_item_uncovered.dart';
            ...
            children: [
              for (var p = 0; p < cart.length; p++)
                WppCartStoreItemUncovered(
                  ...
                  indexItem: p,
                  variantSelected: cart[p].variantSelected != null
                      ? cart[p].variantSelected.variantName
                      : null,
                  image: "images/img_not_found.png",
