...
import 'package:marketplace/ui/screens/web/warung_panen_public/widgets/horizontal_product_list/wpp_horizontal_product_list.dart';
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            // "",
                            "${widget.product.resellerWebStore.name ?? "-"}",
                            style: AppTypo.caption
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                "${widget.product.resellerWebStore.rating ?? "-"}",
                                style: AppTypo.caption
                                    .copyWith(fontWeight: FontWeight.w600),
                              ),
                            ],
                ...
                child: Container(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      ...
                      context.beamToNamed(
                          '/wpp/dashboard/${widget.product.resellerWebStore.slug}',
          ...
          Column(
            ...
            children: [
              ...
              WppHorizontalProductList(
                ...
                products: null,
                warungSlug: widget.product.resellerWebStore.slug,
