...
import 'widgets/transaction_detail/wpp_detail_pesanan_list.dart';
import 'widgets/transaction_detail/wpp_ringkasan_pembayaran.dart';
import 'widgets/transaction_detail/wpp_status_pesanan_widget.dart';

class WppTransaksiDetailWebScreen extends StatefulWidget {
  const WppTransaksiDetailWebScreen({Key key, @required this.paymentId})
      : super(key: key);

  final int paymentId;

  @override
  _WppTransaksiDetailWebScreenState createState() =>
      _WppTransaksiDetailWebScreenState();
}

class _WppTransaksiDetailWebScreenState
    extends State<WppTransaksiDetailWebScreen> {
  @override
  void initState() {
    super.initState();
    context
