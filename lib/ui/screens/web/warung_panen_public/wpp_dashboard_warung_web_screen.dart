...
class _WppDashboardWarungWebScreenState
  ...
  void bsAddress() {
    WppBsSearchKecamatan.show(
      ...
      description:
          "Tentukan domisili anda agar kami bisa memberikan rekomendasi komunitas, reseller dan produk di sekitar anda",
                ...
                if (state is FetchProductsResellerShopSuccess) {
                  if (state.resellerProducts.length == 0) {
                    WppBsSearchKecamatan.show(
                      context,
                      useCloseButton: false,
                      image: AppImg.img_not_found,
                      title:
                          "Mohon maaf produk toko ini belum tersedia di daerah anda",
                      description:
                          "Tapi jangan khawatir, yuk cari reseller disekitarmu",
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              leading: Padding(
                  ...
                  child: Image.asset(AppImg.ic_ekomad_colored,
                      width: 30, height: 30)),
              titleSpacing: 0,
              title: Container(
                height: 50,
                              ...
                              : state is FetchProductsResellerShopSuccess
                                  ? state.resellerProducts.length > 0
                                      ? MasonryGridView.count(
                                          ...
                                          crossAxisCount: 2,
                                          itemCount:
                                              state.resellerProducts.length,
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            Products _item =
                                                state.resellerProducts[index];
                                            return GridTwoProductListItem(
                                              // product: _item,
                                              warungSlug: widget.slugReseller,
                                              isDiscount: _item.disc != 0,
                                              isUpgrader: false,
                                              isPublicWarung:
                                                  widget.slugReseller != null,
                                            );
                                          },
                                          mainAxisSpacing: 13,
                                          crossAxisSpacing: 13,
