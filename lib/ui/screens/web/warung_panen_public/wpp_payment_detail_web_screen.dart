                ...
                body: AppTrans.SharedAxisTransitionSwitcher(
                  ...
                  child: ListView(
                    padding: EdgeInsets.symmetric(
                        horizontal:
                            !context.isPhone ? 20 : _screenWidth * (10 / 100),
                        vertical:
                            !context.isPhone ? 0 : _screenWidth * (3 / 100)),
                    children: [
                      Image.asset(
                        AppImg.img_payment_success,
                        height:
                            !context.isPhone ? 200 : _screenWidth * (50 / 100),
                      ),
                      SizedBox(
                        height: 30,
                      ),
                      ...
                      Text(
                        "Rp" + AppExt.toRupiah(widget.orderData.payment.amount),
                          ...
                          Container(
                            ...
                            child: OutlineButton(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(50)),
                              onPressed: () => _handleCopy(
                                  widget.orderData.payment.amount.toString(),
                        ...
                        children: [
                          ...
                          RoundedButton.contained(
                            ...
                            onPressed: () {
                              ...
                              _recipentRepo.setRecipentUserNoAuthDashboard(
                                subdistrictId:
                                    _recipentRepo.getSelectedRecipentNoAuth()[
                                        'subdistrict_id'],
