...
import 'widgets/product_detail/wpp_product_detail_appbar.dart';
import 'widgets/product_detail/wpp_product_detail_body.dart';
import 'widgets/wpp_bs_product_detail_not_coverage.dart';
import 'widgets/wpp_bs_search_kecamatan.dart';
...
class _WppProductDetailWebScreenState extends State<WppProductDetailWebScreen>
  ...
  void bsAddress() {
    WppBsSearchKecamatan.show(
      ...
      title: "Dimana domisili anda sekarang?",
      description:
          "Tentukan domisili anda agar kami bisa memberikan rekomendasi komunitas dan produk di sekitar anda",
                ...
                listener: (ctx, state) {
                  if (state is FetchProductDetailFailure) {
                    WppBsSearchKecamatan.show(
                      ...
                      title: state.message,
                      description:
                          "Silahkan memilih kecamatan, agar kami bisa merekomendasikan reseller untuk anda",
                      onTap: (subdistrictId, subdistrictVal) {
                        debugPrint(subdistrictVal);
                        // _productCoverageValidationCubit.productCoverageValidate(
                        //     productId: widget.productId, subdistrictId: subdistrictId);
