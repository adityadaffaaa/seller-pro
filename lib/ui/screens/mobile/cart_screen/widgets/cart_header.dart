...
class _CartHeaderState extends State<CartHeader> {
  ...
  bool isPilihSemuaChecked;

  @override
  void initState() {
    super.initState();
    isPilihSemuaChecked = false;
            ...
            BlocBuilder<DeleteCartItemCubit, DeleteCartItemState>(
              ...
              builder: (context, state) {
                ...
                ()
                {
                  ...
                  //       content: Text('Centang pilih semua terlebih dahulu'),
                ...
                "Hapus Semua",
                style: AppTypo.caption
                      .copyWith(color: isPilihSemuaChecked ? Theme
                      .of(context)
