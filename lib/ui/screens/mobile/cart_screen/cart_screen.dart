...
import 'package:marketplace/ui/screens/mobile/cart_screen/widgets/cart_body.dart';
import 'package:marketplace/ui/screens/mobile/cart_screen/widgets/cart_footer.dart';
import 'package:marketplace/ui/screens/mobile/cart_screen/widgets/cart_header.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _passingDataCartToCheckout() {
    ...
    if (!kIsWeb) {
      ...
      // );
      context.beamToNamed(
          '/checkout?dt=${AppExt.encryptMyData(jsonEncode(listCart))}');
    }
  }
                      ...
                      listener: (context, state) async {
                        if (state is CartStockValidationSuccess) {
                          if (kIsWeb &&
                            ...
                            final state = context.read<IncDecCartCubit>().state;
