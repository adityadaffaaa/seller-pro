                                                          ...
                                                          children: [
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                  child: Text(
                                                                      "Silahkan selesaikan pembayaran anda dengan bank yang sudah anda pilih",
                                                                      style: AppTypo
                                                                          .caption),
                                                                )
                                                              ],
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            Image.asset(
                                              AppImg.img_payment_success,
                                              height: kIsWeb ? _screenWidth * (20 / 100) : _screenWidth * (65 / 100),
                                            ),
                                            SizedBox(
                                              height: 40,
                                            ),
                                              ...
                                              padding: EdgeInsets.symmetric(
                                                  horizontal: kIsWeb
                                                      ...
                                                      : _screenWidth *
                                                          (10 / 100)),
                                              child: Text(
                                                "Terimakasih sudah belanja di ekomad. Pesanan anda akan segera kami proses",
                                                textAlign: TextAlign.center,
                                                style: AppTypo.body2Lato
                                                    .copyWith(
                                                        color: AppColor.grey),
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                label.toUpperCase(),
                style: AppTypo.h3.copyWith(fontSize: kIsWeb ? 14 : 16),
              ),
            ),
            Icon(
              selected
