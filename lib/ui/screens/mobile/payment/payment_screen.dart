...
import 'package:marketplace/ui/screens/mobile/checkout/widgets/deliver_address_item.dart';
import 'package:marketplace/ui/screens/mobile/payment/payment_detail_screen.dart';
import 'package:marketplace/ui/screens/mobile/payment/webview_ads_payment_screen.dart';
                  ...
                  if (state is AddOrderSuccess) {
                    ...
                    if (kIsWeb) {
                      if (_selectedPayment.slug == "ads-payment") {
                        AppExt.toWebUrl(context,state.data.payment.link);
                      } else {
                        WppInvoice wppInvoice = WppInvoice(
                            order: state.data,
                            authCheckout: widget.checkoutTemp);
                        context.beamToNamed(
                            '/paymentdetail?dt=${AppExt.encryptMyData(jsonEncode(wppInvoice))}');
                      }
                    } else {
                      AppExt.popScreen(context);
                            ...
                            return <Widget>[
                              SliverAppBar(
                                ...
                                title: Text(
                                    "Metode Pembayaran",
                                    style: kIsWeb
                                        ? AppTypo.subtitle2.copyWith(color: Colors.black)
                                        : TextStyle(),
                                ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Visibility(
                                        visible:
                                            widget.checkoutTemp.potonganSaldo !=
                                                0,
                                        child: dataTable.detail("Saldo Dompet",
