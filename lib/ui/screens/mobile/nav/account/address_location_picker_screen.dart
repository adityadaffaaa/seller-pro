...
class AddressLocationPickerScreen extends StatefulWidget {
  const AddressLocationPickerScreen({Key key, this.onLocationPicker})
      : super(key: key);
                                  ...
                                  FloatingActionButton(
                                    child: _isGetCurrentLoading
                                        ...
                                        : Icon(Boxicons.bx_current_location,
                                            color: Colors.white),
                                    backgroundColor: AppColor.primary,
                                    onPressed: _isGetCurrentLoading
                                        ? null
                                        : _onMapCurrTap,
                                  ),
                                ],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RoundedButton.contained(
                              ...
                              isUpperCase: false,
                              onPressed: () {
                                widget.onLocationPicker(RecipentLocationPicker(
                                    address: _address,
                                    latitude:
