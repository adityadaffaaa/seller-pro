...
class _ViewAllProductScreenState extends State<ViewAllProductScreen> {
  ...
  void initState() {
    if (!widget.isRecomProduct) {
      ...
      _fetchProductsCubit = FetchProductsCubit()
        ..fetchProductsRandomByCategory(categoryId: widget.categoryId);
      print("masuk sini dengan categoryId: ${widget.categoryId}");
    }
    super.initState();
  }
  ...
  AppBar _buildAppBar(BuildContext context, double _screenWidth) {
    return AppBar(
      ...
      bottom: PreferredSize(
        ...
        child: Padding(
          padding: EdgeInsets.only(right: _screenWidth * (4 / 100), bottom: 6),
          child: Row(
