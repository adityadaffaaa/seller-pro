...
class ShimmerSelectedRecipent extends StatelessWidget {
  const ShimmerSelectedRecipent({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.symmetric(
          horizontal: kIsWeb ? 15 : screenWidth * (5 / 100), vertical: 10),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return SizedBox(
                        width: 100,
                        height: 50,
                        child: ShimmerProductItem(isPromo: isPromo));
                  },
                ),
