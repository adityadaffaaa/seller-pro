                          ...
                          (item) => kIsWeb
                              ? MouseRegion(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      item.link != ""
                                          ? AppExt.toWebUrl(context, item.link)
                                          : null;
                                    },
                                    child: Image(
...
class CarouselProduct extends StatefulWidget {
  final List<ProductAssets> images;
                      ...
                      items: widget.images
                          .map(
                            (item) => GestureDetector(
                              onTap: () => item.videoLink != null
                                  ? AppExt.toWebUrl(context, item.videoLink)
                                  : showDialog(
                                      context: context,
                                                            ...
                                                            (data) => kIsWeb
                                                                ...
                                                                : Stack(
                                                                    children: [
                                                                      CachedNetworkImage(
                                                                        imageUrl:
                                                                            "${data.image ?? 'https://venus.bisnisomall.com/images/blank.png'}",
                                                                        fit: BoxFit
                                                                            .contain,
                                                                        memCacheHeight:
                                                                            (Get.height * 1).toInt(),
                                  ...
                                  : Stack(
                                      children: [
                                        CachedNetworkImage(
                                          ...
                                          imageUrl:
                                              "${item.image ?? AppConst.IMG_BLANK_URL}",
                                          fit: BoxFit.cover,
                                          memCacheHeight:
                                              (Get.height * 1).toInt(),
                                          placeholder: (context, url) =>
                        ...
                        child: kIsWeb
                            ? Stack(
                                children: [
                                  ...
                                  widget.images[index].videoLink != null
                                      ? Center(
                                          child: Icon(
                                          Icons.play_arrow,
                                          color: AppColor.primary,
